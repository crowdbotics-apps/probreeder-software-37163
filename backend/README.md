...
## Project Structure
    ...
    ├── probreeder_software_37163  # Django project configurations
...
1. Clone this repo and `cd probreeder_software_37163`
...
2. Clone this repo and `cd probreeder_software_37163`
